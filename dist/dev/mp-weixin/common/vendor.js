...
exports.typeMap = exports.limit = void 0;
var limit = 10;
exports.limit = limit;
var typeMap = {
  1: '判断题',
...
var transQuestion = function transQuestion(data) {
  return data.map(function (x) {
    var a = x.a,
        ...
        f = x.f,
        answer = x.answer,
        rest = _objectWithoutProperties(x, ["a", "b", "c", "d", "e", "f", "answer"]);
